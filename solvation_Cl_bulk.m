...
for t=1:n
  ...
  % a221 = find(a1(:,2)==9 & a1(:,5)>z_brush_lo(t,1)+5 & a1(:,5)<z_brush_hi(t,1)-5 & a1(:,3)>50);
   a22 = find(a1(:,2)==11 & a1(:,5)>z_brush_lo(t,1)+8 & a1(:,5)<z_brush_hi(t,1)-8 & a1(:,3)>50);
 %  a22 = vertcat(a221,a222); %ion
   a23 = find(a1(:,2)==7 & a1(:,5)>z_brush_lo(t,1) & a1(:,5)<z_brush_hi(t,1)-8 & a1(:,3)>45); %water
   a24 = find(a1(:,2)==5 ); %coo
   for ii=1:length(a22)
       nion=nion+1;
       k=a22(ii);
