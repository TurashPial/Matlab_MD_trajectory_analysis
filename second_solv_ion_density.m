...
for t=1:n
   ...
   for ii=1:length(a22)
       ...
       for jj=1:length(a23)
           ...
           if ((distance(jj)>6.2) && (distance(jj) < 10.2))
           a22_second=jj;
           else
               a22_second=a22_second;
           end
       end
       ...
       if a22_second>0
       a22_second1=a22(ii);
       a22_second_all = horzcat(a22_second_all,a22_second1);
       end
   end
   a22_free_dist = find(distance_min(2,:)<cutoff);
   a22_free = (a22(a22_free_dist));
   a22_common = intersect(a22_second_all,a22_free);
   a22_only_second = setxor(a22_second_all,a22_common);
%................................... plot distribution ................
Xtime=[0;0];
   for kk = 1:nbins
       clear loc
